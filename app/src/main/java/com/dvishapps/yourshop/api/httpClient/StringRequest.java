...
public class StringRequest<T> extends Request<T> {
     ...
     * @param params
     */
    StringRequest(int method, String url, Map<String, String> headers, Type type, Response.Listener<T> listener,
     ...
     * @param errorListener the error listener
     */
    StringRequest(int method, String url, Map<String, String> params, Map<String, String> headers, Type type, Response.Listener<T> listener,
