...
import com.dvishapps.yourshop.databinding.ShopListTopChoiceItemBinding;
...
public class ShopListTopChoiceAdapter extends RecyclerView.Adapter<ShopListTopChoiceAdapter.OrderViewHolder> implements Cloneable, Filterable {
    ...
    public ShopListTopChoiceAdapter(List<Shop> shopList, OnTransactionListener onOrderListener, OnTransactionCallListener onTransactionCallListener, OnQrCodeClickListener onQrCodeClickListener) {
    ...
    public ShopListTopChoiceAdapter(List<Shop> shopList, OnTransactionListener onOrderListener) {
        this.shopList = shopList;
        this.onOrderListener = onOrderListener;
    }
    ...
    public class OrderViewHolder extends RecyclerView.ViewHolder {
        private ShopListTopChoiceItemBinding binding;
        private OnTransactionListener onOrderListener;
        private OnTransactionCallListener onTransactionCallListener;
        private OnQrCodeClickListener onQrCodeClickListener;

        public OrderViewHolder(@NonNull ShopListTopChoiceItemBinding binding, OnTransactionListener onOrderListener, OnTransactionCallListener onTransactionCallListener, OnQrCodeClickListener onQrCodeClickListener) {
...
//                binding.distance.setText(Tools.round1(distanceNew) + "km");
                binding.distance.setText(shop.getDistance() + "km");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ShopListTopChoiceItemBinding binding = ShopListTopChoiceItemBinding.inflate(inflater, parent, false);
