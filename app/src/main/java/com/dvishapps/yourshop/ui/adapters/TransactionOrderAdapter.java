...
public class TransactionOrderAdapter extends RecyclerView.Adapter<TransactionOrderAdapter.OrderViewHolder> {

    private List<Transaction> transactions;
    private OnTransactionListener onOrderListener;
    private OnTransactionOrderClickListener onTransactionOrderClickListener;
    private OnTransactionCancelListener onTransactionCancelListener;

//    public TransactionOrderAdapter(List<Transaction> transactions, OnTransactionListener onOrderListener, OnTransactionCancelListener onTransactionCancelListener) {
//        this.transactions = transactions;
//        this.onOrderListener = onOrderListener;
//        this.onTransactionCancelListener = onTransactionCancelListener;
//    }
//
//    public TransactionOrderAdapter(List<Transaction> transactions, OnTransactionListener onOrderListener) {
//        this.transactions = transactions;
//        this.onOrderListener = onOrderListener;
//    }

//    public TransactionOrderAdapter(List<Transaction> transactions, OnTransactionListener onOrderListener, OnTransactionOrderClickListener onTransactionOrderClickListener) {
//        this.transactions = transactions;
//        this.onOrderListener = onOrderListener;
//        this.onTransactionOrderClickListener = onTransactionOrderClickListener;
//    }


    public TransactionOrderAdapter(List<Transaction> transactions, OnTransactionOrderClickListener onTransactionOrderClickListener) {
        this.transactions = transactions;
        this.onTransactionOrderClickListener = onTransactionOrderClickListener;
    }
    ...
    public class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        public OrderViewHolder(@NonNull OrderItemBinding binding, OnTransactionListener onOrderListener, OnTransactionCancelListener onTransactionCancelListener,OnTransactionOrderClickListener onTransactionOrderClickListener) {
        ...
        public void bind(Transaction transaction) {
            ...
            binding.details.setOnClickListener(v -> {
                onTransactionOrderClickListener.onViewDetail(transaction);
            });
...
//                        || transaction.getTrans_status_id().equals("6")
    ...
    public void cancelItem(Transaction  transaction) {
        boolean exist=false;
        for (int i = 0; i < transactions.size(); i++) {
    ...
    public void removeItem(String transactionId) {
        for (int i = 0; i < transactions.size(); i++) {
            if (transactions.get(i).getId().equals(transactionId)){
    ...
    public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OrderViewHolder(binding, onOrderListener, onTransactionCancelListener,onTransactionOrderClickListener);
    }
    ...
    public interface OnTransactionOrderClickListener {
        void onViewDetail(Transaction transaction);
    }
