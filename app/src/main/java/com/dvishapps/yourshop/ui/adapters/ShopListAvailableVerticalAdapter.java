...
public class ShopListAvailableVerticalAdapter extends RecyclerView.Adapter<ShopListAvailableVerticalAdapter.OrderViewHolder> implements Cloneable, Filterable {
    ...
    public ShopListAvailableVerticalAdapter(List<Shop> shopList, OnTransactionListener onOrderListener, OnTransactionCallListener onTransactionCallListener, OnQrCodeClickListener onQrCodeClickListener) {
    ...
    public ShopListAvailableVerticalAdapter(List<Shop> shopList, OnTransactionListener onOrderListener) {
        this.shopList = shopList;
