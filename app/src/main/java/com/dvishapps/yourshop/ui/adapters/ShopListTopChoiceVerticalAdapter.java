...
import com.dvishapps.yourshop.databinding.ShopListTopChoiceVerticalItemBinding;
...
public class ShopListTopChoiceVerticalAdapter extends RecyclerView.Adapter<ShopListTopChoiceVerticalAdapter.OrderViewHolder> implements Cloneable, Filterable {
    ...
    public ShopListTopChoiceVerticalAdapter(List<Shop> shopList, OnTransactionListener onOrderListener, OnTransactionCallListener onTransactionCallListener, OnQrCodeClickListener onQrCodeClickListener) {
    ...
    public ShopListTopChoiceVerticalAdapter(List<Shop> shopList, OnTransactionListener onOrderListener) {
        this.shopList = shopList;
        this.filterShops = new ArrayList<>(shopList);
        this.onOrderListener = onOrderListener;
    }
    ...
    public class OrderViewHolder extends RecyclerView.ViewHolder {
        private ShopListTopChoiceVerticalItemBinding binding;
        private OnTransactionListener onOrderListener;
        private OnTransactionCallListener onTransactionCallListener;
        private OnQrCodeClickListener onQrCodeClickListener;

        public OrderViewHolder(@NonNull ShopListTopChoiceVerticalItemBinding binding, OnTransactionListener onOrderListener, OnTransactionCallListener onTransactionCallListener, OnQrCodeClickListener onQrCodeClickListener) {
        ...
        public void bind(Shop shop) {
            ...
            if (shop.getIs_enable().equals("1")){
                binding.txtOpen.setText("Open");
                binding.txtOpen.setTextColor(Color.BLACK);
                binding.lnrOpen.setBackgroundResource(R.drawable.toggleon);
            }else {
                binding.txtOpen.setText("Closed");
                binding.txtOpen.setTextColor(Color.WHITE);
                binding.lnrOpen.setBackgroundResource(R.drawable.toggleon_red);
            }
    ...
    public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ShopListTopChoiceVerticalItemBinding binding = ShopListTopChoiceVerticalItemBinding.inflate(inflater, parent, false);
